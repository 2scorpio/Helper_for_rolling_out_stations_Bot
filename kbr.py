...
inline_kbr_start_menu.add(InlineKeyboardButton(text="Обновить файл".upper(), callback_data="call_upload_new_file"))
...
inline_kbr_upload_new_file.add(InlineKeyboardButton(text="Назад", callback_data="back"))
inline_kbr_upload_new_file.add(InlineKeyboardButton(text="Скачать образец", callback_data="download_reference_file"))
